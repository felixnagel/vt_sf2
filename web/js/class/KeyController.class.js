/*example:
var keyController = new FnagelKeyController();
...
function FnagelKeyController(){
	'use strict'; var self = this;
	window.onkeydown = function(event){
		var keyCode = event.keyCode;
		if(!self.registeredKeys[keyCode] || !self.registeredKeys[keyCode].keyDown){
			return;
		}
...
FnagelKeyController.prototype = {
	registeredKeys: {},
	dispatch_event: function dispatch_event(keyCode){
		var event = new Event('FnagelKeyController');
		event.keys = this.registeredKeys;
